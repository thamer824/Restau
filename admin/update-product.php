            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($img_name!="")
                    {
                        ...
                        //REname the Image
                        $ext = end(explode('.', $img_name)); //Gets the extension of the image

                        $image_name = "product-".rand(0000, 9999).'.'.$ext; //THis will be renamed image

                        //Get the Source Path and DEstination PAth
                        $src_path = $_FILES['image']['tmp_name']; //Source Path
                        $dest_path = "../images/category/".$img_name; //DEstination Path
                    ...
                    {
                        $img_name = $current_image; //Default Image when Image is Not Selected
                    }
                }
                else
                {
